-- ============================================================================
-- MIGRATION: 014_mejorar_trigger_factura_electronica.sql
-- DESCRIPCIÓN: Mejorar trigger para capturar datos completos del cliente,
--              items de venta y métodos de pago para ventas POS
-- FECHA: 2025-12-27
-- ============================================================================
...
BEGIN
  ...
  IF NEW.cliente_id IS NOT NULL THEN
    SELECT
      ...
      telefono,
      direccion,
      COALESCE(codigo_municipio, '11001')  -- Bogotá por defecto (campo real en tabla clientes)
    INTO
      v_cliente_nombre,
      v_cliente_documento,
      v_cliente_tipo_doc,
...
COMMENT ON FUNCTION crear_factura_electronica_automatica() IS
  'Función del trigger para crear facturas electrónicas automáticamente con datos completos del cliente, items y métodos de pago';
